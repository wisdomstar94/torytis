...
pub fn routes() -> Router {
    Router::new()
        .route("/category", get(root_route))
        .route("/category/{category_name}", get(category_index_route))
        .route("/category/{category_name}/{sub_category_name}", get(category_sub_category_index_route))
